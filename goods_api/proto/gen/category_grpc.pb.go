...
const (
	...
	Category_GetAllCategories_FullMethodName = "/Category/GetAllCategories"
)
...
type CategoryClient interface {
	...
	UpdateCategory(ctx context.Context, in *UpdateCategoryInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetSubCategory(ctx context.Context, in *CategoryInfoRequest, opts ...grpc.CallOption) (*SubCategoryListResponse, error)
	GetAllCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error)
}
...
func (c *categoryClient) CreateCategory(ctx context.Context, in *CreateCategoryInfo, opts ...grpc.CallOption) (*CategoryInfoResponse, error) {
...
func (c *categoryClient) DeleteCategory(ctx context.Context, in *DeleteCategoryInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *categoryClient) UpdateCategory(ctx context.Context, in *UpdateCategoryInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *categoryClient) GetSubCategory(ctx context.Context, in *CategoryInfoRequest, opts ...grpc.CallOption) (*SubCategoryListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *categoryClient) GetAllCategories(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryListResponse)
	err := c.cc.Invoke(ctx, Category_GetAllCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServer interface {
	...
	UpdateCategory(context.Context, *UpdateCategoryInfo) (*emptypb.Empty, error)
	GetSubCategory(context.Context, *CategoryInfoRequest) (*SubCategoryListResponse, error)
	GetAllCategories(context.Context, *emptypb.Empty) (*CategoryListResponse, error)
...
func (UnimplementedCategoryServer) CreateCategory(context.Context, *CreateCategoryInfo) (*CategoryInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateCategory not implemented")
}
func (UnimplementedCategoryServer) DeleteCategory(context.Context, *DeleteCategoryInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteCategory not implemented")
}
func (UnimplementedCategoryServer) UpdateCategory(context.Context, *UpdateCategoryInfo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCategory not implemented")
}
func (UnimplementedCategoryServer) GetSubCategory(context.Context, *CategoryInfoRequest) (*SubCategoryListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubCategory not implemented")
}
func (UnimplementedCategoryServer) GetAllCategories(context.Context, *emptypb.Empty) (*CategoryListResponse, error) {
...
func _Category_CreateCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).CreateCategory(ctx, req.(*CreateCategoryInfo))
	}
...
func _Category_DeleteCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).DeleteCategory(ctx, req.(*DeleteCategoryInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Category_UpdateCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).UpdateCategory(ctx, req.(*UpdateCategoryInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Category_GetSubCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).GetSubCategory(ctx, req.(*CategoryInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
